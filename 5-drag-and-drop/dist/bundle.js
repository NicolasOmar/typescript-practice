...
(function (App) {
    ...
    App.globalProjectState = ProjectState.getInstance();
})(App || (App = {}));
var App;
(function (App) {
    let ProjectStatus;
...
(function (App) {
    class ProjectList extends App.Component {
        ...
        configure() {
            ...
            App.globalProjectState.addListener((projects) => {
                this.assignedProjects = projects.filter(_project => {
                    return this.type === 'active'
                        ? _project.status === App.ProjectStatus.Active
                        : _project.status === App.ProjectStatus.Finished;
                });
                this.renderProjects();
            });
        }
        ...
        dropHandler(event) {
            ...
            App.globalProjectState.moveProject(projectId, this.type === 'active' ? App.ProjectStatus.Active : App.ProjectStatus.Finished);
        }
        dragLeaveHandler(_) {
            const listElem = this.element.querySelector('ul');
    ...
    class ProjectInput extends App.Component {
        ...
        submitHandler(event) {
            ...
            if (Array.isArray(userInputs)) {
                App.globalProjectState.addProject(...userInputs);
                this.clearInputs();
            }
        }
        configure() {
        ...
        gatherUserInput() {
            ...
            if (App.validate(titleValidator) &&
                App.validate(descriptionValidator) &&
                App.validate(peopleValidator)) {
